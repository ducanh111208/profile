...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/profile.php?id=100074776546372', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@duc.anh.lap.trinh', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('http://zaloapp.com/qr/p/1a0zi2ztqanfj', '_blank');
    });
});
...
welcomeText.textContent = "Designed By Duc Anh =))";
